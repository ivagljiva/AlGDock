((window) ->
  ...
  TEMPLATES["proteinScript"] = `new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<li><a href=\"#\" data-toggle=\"modal\" data-target=\"#proteinSelectionModal\" style=\"color: white; background-color: #00898e;\">Create Protein</a></li>");if(t.s(t.f("proteinList",c,p,1),c,p,0,161,198,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<li><a href=\"#\">");t.b(t.v(t.f("filename",c,p,0)));t.b("</a></li>");});c.pop();}return t.fl(); },partials: {}, subs: {  }});`
