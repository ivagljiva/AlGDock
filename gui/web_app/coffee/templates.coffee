((window) ->
  ...
  TEMPLATES["ligandSelectionScript"] = `new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");if(t.s(t.f("ligandRegex",c,p,1),c,p,0,16,78,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<div class=\"alert alert-success\" role=\"alert\">");t.b(t.v(t.f("ligand",c,p,0)));t.b("</div>");});c.pop();}return t.fl(); },partials: {}, subs: {  }});`
